...
shorter quick-reference version, see the main [README.md](../README.md) —
this document goes deeper on each step and on troubleshooting.
...
installer, see the **"For Developers"** section of
[README.md](../README.md) — it covers `setup.bat`, `npm run dev`, building
the installer with `build-installer.bat`, and the underlying database
commands.
